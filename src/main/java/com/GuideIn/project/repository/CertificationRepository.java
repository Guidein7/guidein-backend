...
public interface CertificationRepository extends JpaRepository<Certification,Long>{
	...
	@Query(value="select * from certifications where ?1 is null or course_category=?1",nativeQuery=true)
	Page<Certification> getdataByFilter(String courseCategory, Pageable pageable);
